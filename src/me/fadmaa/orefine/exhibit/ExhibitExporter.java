...
public class ExhibitExporter implements StreamExporter {
	...
	private String getHTML(Project project, Properties options) {
		...
		try {
			...
			for (int i = 0; i < facetsArr.length(); i += 1) {
				...
				builder.append("<div class=\"").append(fclass)
						.append("\" data-ex-role=\"exhibit-facet\" data-ex-expression=\"");
				...
				builder.append("\" id=\"facet-").append(i);
				builder.append("\"></div>\n");
			}
			...
			viewsHtml.append(
					"<div data-ex-role=\"view\" data-ex-label=\"Table\" data-ex-view-class=\"Tabular\" data-ex-columns=\"");
			...
			public boolean visit(Project project, int rowIndex, Row row) {
				try {
					...
					for (Column col : project.columnModel.columns) {
						...
						writeField(jsonGen, fieldName, value);
					}
					for (Expression e : expressions) {
						Object v = evaluateExpression(project, e.expr, e.col, row, rowIndex);
						writeField(jsonGen, e.hiddenName, v);
					}
	...
	private Object evaluateExpression(Project project, String expression, String columnName, Row row, int rowIndex)
	...
	private void writeField(JsonGenerator jsonGen, String fieldName, Object value) throws JsonGenerationException, IOException {
		if (value != null) {
